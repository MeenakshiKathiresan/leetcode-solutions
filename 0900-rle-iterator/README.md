...
<ul>
	...
	<li><code>int next(int n)</code> Exhausts the next <code><l-core class="L-underline"><l-core class="L-underline">n</l-core></l-core></code><l-core class="L-underline"><l-core class="L-underline"> elements and returns the last element exhausted in this w</l-core></l-core>ay. If there is no element left to exhaust, return <code>-1</code> instead.</li>
</ul>
